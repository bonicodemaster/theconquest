...
export function username(seed: string): string {
  const adj = ["Brave", "Sage", "Rapide", "Vaillant", "Silencieux", "Cramoisi", "Mystique", "Fer", "Givre", "Lunaire"];
  const noun = ["Renard", "Loup", "Aigle", "Tigre", "Cobra", "Faucon", "Ours", "Lion", "Faucon", "Panda"];
